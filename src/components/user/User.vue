...
<!--                    作用域插槽-->
                    <template slot-scope="scope" @change="userStateChange(scope.row)">
<!--                     获取这一行的数据   -->
<!--                        {{scope.row}}-->
...
<!--                        分配角色按钮-->
                        <el-tooltip  effect="dark" content="分配角色" placement="top" :enterable="false">
                            <el-button size="mini" type="warning" icon="el-icon-setting"></el-button></el-tooltip>
                    </template>
                </el-table-column>
            </el-table>
<!--            分页区域-->
...
<script>
 ...
 data(){
     ...
     var checkMobile =(rule,value,cb) => {
         // 验证手机号的正则表达式
         const regMobile=/^1((3|5|6|7|8|9){1}\d{1})\d{8}$/;
     ...
     return{
         ...
         addFormRules:{
             ...
             password:[{
                 ...
                 min:6,max:15,message: '请用户名的长度在3-10个字符之间',trigger:'blur'
             }],
             email:[{
